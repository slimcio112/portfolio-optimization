...
* **Statistical analysis** Computes daily logarithmic returns, annualized covariation matrix and correlation between the assets.
* **Monte carlo simulation** Simulates 10 000 random portfolios to visualize the risk/return.
* **Optimization** Picks one portfolio with highest Sharpe ratio and one portfolio with lowest risk (volatility).
...
*scatter plot of Sharpe ratio for Monte Carlo Simulation of 10 000 portfolios*
...
* **optimal portfolio** suggests investment in stocks like **MSFT, AAPL** but also investment in less correlated stock **TSLA**.
